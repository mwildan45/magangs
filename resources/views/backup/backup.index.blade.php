				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-12">
							<h1 class="text-white">
								<span>1500+</span> Siswa SMK Mencari Tempat Magang Disini				
							</h1>	
							<form action="search.html" class="serach-form-area">
								<div class="row justify-content-center form-wrap">
									<div class="col-lg-4 form-cols">
										<input type="text" class="form-control" name="search" placeholder="Fuck Yourself?">
									</div>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6">
							<div class="single-feature">
								<h4>Pencarian</h4>
								<p>
									Mudah, banyak pilihan sesuai kejuruan.
								</p>
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
							<div class="single-feature">
								<h4>Penerimaan</h4>
								<p>
									Cepat, tanpa ribet langsung bisa magang.
								</p>
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
							<div class="single-feature">
								<h4>Keamanan</h4>
								<p>
									Terpercaya, bisa diandalkan di lebih dari 100+ DU/DI.
								</p>
							</div>
						</div>
						<div class="col-lg-3 col-md-6">
							<div class="single-feature">
								<h4>Notifikasi</h4>
								<p>
									Selalu diperbarui, dimanapun dan di device apapun.
								</p>
							</div>
						</div>																		
					</div>
					...
					<div class="row align-items-center">
						<div class="active-popular-post-carusel">
							<div class="single-popular-post d-flex flex-row">
								<div class="thumb">
									<img class="img-fluid" src="{{asset('assets/img/p1.png')}}" alt="">
									<a class="btns text-uppercase" href="#">  Lihat...</a>
								</div>
								<div class="details">
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-10">
							<div class="title text-center">
								<h1 class="mb-10">Menampilkan Kategori Kejuruan</h1>
								<p>Dimana apa saja bisa didapatkan disini.</p>
							</div>
						</div>
					</div>						
					<div class="row">
						...
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
								...
								<p>Teknologi Pengolahan Bahan Pangan</p>
							</div>
						</div>
						<div class="col-lg-2 col-md-4 col-sm-6">
							<div class="single-fcat">
				...
				<div class="container">
					<div class="row justify-content-center d-flex">
						<div class="col-lg-8 post-list">
							...
							@foreach($dudi as $ddudi)
							<div class="single-post d-flex flex-row">
								<div class="thumb">
									<img src="{{asset('assets/images/user/dudi/'.$ddudi->logo)}}" alt="" width="109px" height="69px">
									<ul class="tags">
										<li>
											<a href="#">{{str_limit($ddudi->jurusan, 6)}}</a>
										</li>
										<li>
											<a href="#">Media</a>
										</li>
								...
								<div class="details">
									<div class="title d-flex flex-row justify-content-between">
										<div class="titles">
											<a href="single.html"><h4>{{ $ddudi->nama_dudi }}</h4></a>
											<h6>{{$ddudi->status}}</h6>					
										</div>
										<ul class="btns">
							...
							<div class="single-slidebar">
								...
								<div class="active-relatedjob-carusel">
									<div class="single-rated">
										<img class="img-fluid" src="{{asset('assets/img/r1.jpg')}}" alt="">
