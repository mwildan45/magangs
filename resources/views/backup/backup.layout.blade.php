	...
	<head>
		...
		<!-- Favicon-->
		<link rel="shortcut icon" href="{{asset('assets/img/fav.png')}}5">
		<!-- Author Meta -->
		...
		<link href="https://fonts.googleapis.com/css?family=Poppins:100,200,400,300,500,600,700" rel="stylesheet"> 
			...
			<link rel="stylesheet" type="text/css" href="{{asset('assets/modal_login/login-register.css')}}">
		</head>
			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="{{ route('data.index')}}">Data Diri</a></li>
				          ...
				          <li><a class="ticker-btn" href="#" style="color: #000;">{{ Auth::user()->username }}</a></li>
				          <li> <a class="ticker-btn" href="{{ route('logout') }}"
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://google.com" target="_blank">Wildan</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
						</p>
