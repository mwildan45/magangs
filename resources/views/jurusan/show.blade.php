...
<p>Cari pada pencarian dibawah ini untuk mencari tempat magang di jurusan {{$idj->nama_jurusan}}.</p>
</div>
<form action="{{ url('search-in-jurusan')}}" method="get">
<div class="col-lg-12 col-md-12 col-xs-12">
...
<input type="hidden" name="jurusan" value="{{$idj->id}}">
...
<div class="container">
<div class="row">
	<h5 class="widget-title wtitle-custom">Menampilkan Tempat Magang Jurusan <p class="p-custom">{{$idj->nama_jurusan}}</p></h5>
...
<div class="tags">
<span><i class="lni-map-marker"></i> {{str_limit($data->lokasi, 20)}}</span>
...
<h2 class="section-title p-custom">Masih Belum Ada Tempat Magang di Jurusan Ini.</h2>
<p>Cari di <a href="{{route('jurusan.index')}}">Jurusan Lain.</a></p>
</div>
@endif
 </div>
