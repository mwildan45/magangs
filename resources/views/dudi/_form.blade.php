...
<input type="text" class="form-control" placeholder="Tulis Judul Pendaftaran Tempat Magang Yang Baru." name="judul" required="">
 @if ($errors->has('judul'))
...
<div class="row">
    <div class="col-lg-6 col-md-6 col-xs-12">
        <label class="control-label">Tanggal Dimulai</label>
        <input type="date" name="date_begin" class="form-control" placeholder="Atur tanggal dimulainya prakerind">
        <p>(Atur tanggal dimulainya prakerind).</p>
    </div>
    <div class="col-lg-6 col-md-6 col-xs-12">
        <label class="control-label">Tanggal Berakhir</label>
        <input type="date" name="date_end" class="form-control" placeholder="Atur tanggal dimulainya prakerind">
...
<label class="custom-file-label form-control" for="validatedCustomFile">Pilih Foto... (Bisa lebih dari satu. Maks 5)</label>
 @if ($errors->has('foto'))
    <div class="help-block">
...
<p style="text-align: center;margin-bottom: 20px;">Anda tidak bisa mengubah section ini disini. Untuk mengubahnya, pergi ke halaman Edit Account yang berada di menu Account DU/DI anda.</p>
</div>
<div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
<label class="control-label">Nama Perusahaan/Instansi</label>
<input type="text" class="form-control" placeholder="Tulis nama Perusahaan anda (wajib diisi)." name="nama" value="{{$dudi->detail_dudi->nama_perusahaan}}" disabled>
 @if ($errors->has('nama'))
    <div class="help-block">
...
<label class="control-label">Deskripsi</label>
<textarea class="form-control" placeholder="Deskripsikan tempat anda." name="deskripsi_dudi" rows="7" disabled>{{$dudi->detail_dudi->deskripsi}}</textarea>
...
<input type="text" class="form-control" placeholder="Tulis situs web" name="situs" value="{{$dudi->detail_dudi->situs_web}}" disabled="">
...
<textarea class="form-control" placeholder="isi alamat utama tempat anda." name="alamat" disabled="">{{$dudi->detail_dudi->alamat}}</textarea>
...
<input type="file" name="logo" class="custom-file-input" id="validatedCustomFile" disabled="">
...
<br><br><br>
<center>
<input type="submit" class="btn btn-common" value="Submit Tempat Anda!">
